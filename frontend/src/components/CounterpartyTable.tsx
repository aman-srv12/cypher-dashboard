...
const CounterpartyTable: React.FC<CounterpartyTableProps> = ({ items }) => {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 bg-transparent rounded-xl shadow-lg">
      ...
      <div className="overflow-x-auto rounded-xl">
        <table
          className={twMerge(
            'min-w-full text-sm text-left table-auto border-collapse',
            isDark
        ...
        >
          ...
          <tbody>
            {sortedItems.map((item, index) => (
              ...
              >
                <td className="px-4 py-4 text-center border-b">{index + 1}</td>
